...
@section('title', 'Registros de dispositivos')
                        ...
                        <div class="panel-heading">
                            <div class="row">
                                <div class="col-sm-5 col-12">
                                    <h4 class="title text-center">Registro de dispositivos</h4>
                                        ...
                                        <table class="table">
                                            ...
                                            <tr>
                                                ...
                                                <th scope="col"><a href="#" id="filtradoNombre"
                                                                   class="d-flex align-items-center text-black justify-content-center">Dispositivo
                                                        <i class="fa-solid fa-sort pl-2"></i></a>
                                                </th>
    ...
    <form id="editForm" method="POST">
        <div id="edit" class="modal fade bd-example-modal-lg" tabindex="-1" role="dialog"
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title text-center" id="editTitle">Editar dispositivo</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                        ...
                        <form id="prestamoForm" action="">
                            <div class="col-md-12 d-flex">
                                ...
                                <div class="col-sm-6 mr-2">
                                    <div class="form-group">
                                        <small class="form-text text-muted">Tipo de dispositivo</small>
                                        <select required class="form-control" id="marca" name="marca">
                                            <option class="hidden" selected disabled>Seleccione el tipo de dispositivo
                                            </option>
    ...
    <form id="addForm" method="POST" action="{{route('register-new-inventory')}}" enctype="multipart/form-data">
        ...
        <div id="add" class="modal fade bd-example-modal-lg" tabindex="-1" role="dialog"
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title text-center" id="addTitle">Nuevo dispositivo</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                        ...
                        <form id="prestamoForm" action="">
                            <div class="col-md-12 px-0 d-flex">
                                <div class="col-sm-6 px-0 mr-2">
                                    ...
                                    <input type="text" name="tipo" value="Dispositivo" style="display: none;">
                                    <div class="form-group">
                                        <small class="form-text text-muted">Identificador</small>
                                        <input required type="text" class="form-control"
                                               name="identificador"
                                               placeholder="Ingrese el identificador del dispositivo"
                                               value=""/>
                                    </div>
                                </div>
                                <div class="col-sm-6">
...
@section('scripts')
    ...
    <script src="{{asset('js/dispositivos-records.js')}}"></script>
@endsection
