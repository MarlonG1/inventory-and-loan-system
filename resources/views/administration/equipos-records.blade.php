...
@section('title', 'Registros de equipos')
...
@section('content')
                        ...
                        <div class="panel-heading">
                            <div class="row">
                                <div class="col-sm-5 col-12">
                                    <h4 class="title text-center">Registro de equipos</h4>
                                        ...
                                        <table class="table">
                                            ...
                                            <tr>
                                                ...
                                                <th scope="col"><a href="#" id="filtradoNombre"
                                                                   class="d-flex align-items-center text-black justify-content-center">Marca
                                                        <i class="fa-solid fa-sort pl-2"></i></a>
                                                </th>
                                            ...
                                            <tr class="row-template" style="display: none;">
                                                ...
                                                <td class="d-flex justify-content-center">
                                                    ...
                                                    <button type="button"
                                                            class="btn text-white btn-primario-claro mr-1 ampliar open-licencias-modal"
                                                            data-toggle="modal" data-target="#showLicencias">
    ...
    <div class="modal fade" id="showLicencias" tabindex="-1" role="dialog" aria-labelledby="showLicenciasTitle"
         aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title text-center" id="showLicenciasTitle">Licencias asignados al equipo</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body px-5 py-4" id="showLicenciasBody">
                    <table class="tabla-reporte" width="100%" style="border: 0">
                        ...
                        <tr class="report-row-sin-resultados" style="display: none;">
                            <td colspan="4" class="text-center">No hay licencias asignadas...</td>
                        </tr>
                        </tbody>
                    </table>
                </div>
    ...
    <form id="editForm" method="POST">
        <div id="edit" class="modal fade bd-example-modal-lg" tabindex="-1" role="dialog"
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title text-center" id="editTitle">Editar equipo</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
    ...
    <form id="addForm" method="POST" action="{{route('register-new-inventory')}}" enctype="multipart/form-data">
        ...
        <div id="add" class="modal fade bd-example-modal-lg" tabindex="-1" role="dialog"
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title text-center" id="addTitle">Nuevo equipo</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                        ...
                        <form id="prestamoForm" action="">
                            <div class="col-md-12 px-0 d-flex">
                                <div class="col-sm-6 px-0 mr-2">
                                    ...
                                    <input type="text" name="tipo" value="Equipo" style="display: none;">
                                    <div class="form-group">
                                        <small class="form-text text-muted">Identificador</small>
                                        <input required type="text" class="form-control"
                                               name="identificador"
...
@section('scripts')
    ...
    <script src="{{asset('js/equipos-records.js')}}"></script>
@endsection
